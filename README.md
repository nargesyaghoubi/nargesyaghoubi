...
[![LinkedIn](https://img.shields.io/badge/-LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/narges-yaghoubi-656a28243/)
...
I'm a Frontend Developer working mainly with **React, Next.js, and TypeScript**, with hands-on experience owning full frontend builds — UI, reusable components, state & data flow, and API integration. Alongside frontend work, I use **Python for AI, Machine Learning, and Deep Learning** projects.

- 🎨 Frontend-focused, comfortable owning a project end to end
- 🐍 Python for AI / ML / Deep Learning
- 🧪 Writing tests with Vitest
- 🤝 Experience on both solo and team projects
...
`Frontend Development` `React & Next.js` `TypeScript` `Python & AI` `Machine Learning` `Collaborative Projects`
